...
import useEmailTemplatePageSubmit from "hooks/useEmailTemplateSubmit";



const EmailTemplateDrawer = ({ id, data, brandList, lang }) => {
      ...
      <div className="w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
        {id ? (
          ...
          <Title
            ...
            description={"Add your Email Template information from here"}
          />
        )}
      </div>
