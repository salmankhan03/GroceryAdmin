...
const Banners = () => {
  ...
  const { data , loading } = useAsync(BannerServices.getBanners);
  ...
  return (
    <>
      ...
      <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 mb-5">
        <CardBody>
          <form onSubmit={handleSubmitBanner} className="py-3 grid gap-4 lg:gap-6 xl:gap-6  xl:flex">
      ...
      {loading ? (
        ...
        <TableContainer className="mb-8">
          <Table>
            ...
            <BannersTable lang={lang} isCheck={isCheck} sliders={dataTable} setIsCheck={setIsCheck} />
          </Table>
          <TableFooter>
            <Pagination
